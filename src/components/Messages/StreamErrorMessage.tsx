  ...
  return (
    <div className={cn("bg-error-bg border border-error rounded px-5 py-4 my-3", className)}>
      <div className="font-primary text-error mb-3 flex items-center gap-2.5 text-[13px] font-semibold tracking-wide">
        ...
        <span className="rounded-sm bg-black/40 px-2 py-0.5 font-mono text-[10px] tracking-wider text-neutral-400 uppercase">
          {message.errorType}
        </span>
        {showCount && (
      ...
      <div className="font-mono text-[13px] leading-relaxed break-words text-neutral-300">
        {message.error}
      </div>
    </div>
  );
