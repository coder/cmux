    ...
    return (
      <div className="flex flex-col gap-5 p-5">
        <ToggleGroup
          ...
          onChange={(newValue) => updateArgs({ value: newValue })}
        />
        <div className="text-gray-500-light font-primary text-xs">
          Current selection: <strong className="text-gray-300">{value}</strong>
        </div>
      </div>
    );
  },
...
export const MultipleGroups: Story = {
  ...
  render: function Render() {
    ...
    return (
      <div className="flex flex-col gap-5 p-5">
        <div>
          <div className="text-gray-500-light font-primary mb-1.5 text-[11px]">Theme</div>
          <ToggleGroup options={themeOptions} value={theme} onChange={handleThemeChange} />
        </div>

        <div>
          <div className="text-gray-500-light font-primary mb-1.5 text-[11px]">Size</div>
          <ToggleGroup options={sizeOptions} value={size} onChange={handleSizeChange} />
        </div>

        <div>
          <div className="text-gray-500-light font-primary mb-1.5 text-[11px]">Layout</div>
