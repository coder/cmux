...
export const ReviewControls: React.FC<ReviewControlsProps> = ({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-b border-neutral-800 bg-neutral-900 px-3 py-2 text-[11px]">
      {onRefresh && <RefreshButton onClick={onRefresh} isLoading={isLoading} />}
      <label className="font-medium whitespace-nowrap text-neutral-500">Base:</label>
      <input
        type="text"
        ...
        className="w-36 rounded border border-neutral-700 bg-neutral-950 px-2 py-1 font-mono text-[11px] text-neutral-200 transition-[border-color] duration-200 placeholder:text-neutral-400 hover:border-sky-600 focus:border-sky-600 focus:outline-none"
      />
      ...
      {showSetDefault && (
        <button
          ...
          className="font-primary hover:bg-white-overlay-light cursor-pointer rounded border-none bg-transparent px-2 py-0.5 text-[11px] whitespace-nowrap text-neutral-500 transition-all duration-200 hover:text-neutral-200"
        >
          Set Default
        </button>
      )}

      <label className="flex cursor-pointer items-center gap-1.5 text-[11px] whitespace-nowrap text-neutral-200 hover:text-white [&_input[type='checkbox']]:cursor-pointer">
        <input
          type="checkbox"
      ...
      <div className="bg-border-neutral-800 h-4 w-px" />

      <div className="rounded border border-transparent bg-transparent px-2.5 py-1 text-[11px] font-medium whitespace-nowrap text-neutral-500">
