    ...
    <div ref={containerRef} className="relative inline-block">
      <div
        className={cn(
          ...
          hasUntracked
            ...
            : "bg-transparent border border-transparent text-neutral-400 cursor-default"
        )}
      ...
      {showTooltip && hasUntracked && (
        <div className="border-bg-medium animate-in fade-in slide-in-from-top-1 absolute top-[calc(100%+8px)] right-0 z-[1000] max-w-96 min-w-48 rounded border bg-neutral-900 p-2 shadow-[0_4px_12px_rgba(0,0,0,0.3)] duration-150">
          <div className="mb-2 border-b border-neutral-800 pb-1.5 text-[11px] font-semibold text-neutral-300">
          ...
          <button
            ...
            disabled={isTracking}
            className={cn(
              "w-full py-1 px-2 bg-transparent text-neutral-400 border border-neutral-700 rounded text-[11px] cursor-pointer transition-all duration-200 font-primary",
              "hover:bg-white-overlay-light hover:text-neutral-300 hover:border-neutral-800-subtle",
