  ...
  return (
    ...
    >
            ...
            {secrets.map((secret, index) => (
              <React.Fragment key={index}>
                <input
                  ...
                  disabled={isLoading}
                  className="border-gray-800-medium placeholder:text-gray-200-dim w-full rounded border bg-gray-900 px-2.5 py-1.5 font-mono text-[13px] text-white focus:border-sky-600 focus:outline-none"
                />
                <input
      ...
      <button
        onClick={addSecret}
        disabled={isLoading}
        className="border-gray-800-medium hover:border-gray-800-darker mb-4 w-full cursor-pointer rounded border border-dashed bg-transparent px-3 py-2 text-[13px] text-gray-500 transition-all duration-200 hover:bg-gray-900 hover:text-gray-200"
      >
        + Add Secret
      </button>
