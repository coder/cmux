...
export function TitleBar() {
  ...
  return (
    <div className="font-primary flex shrink-0 items-center justify-between border-b border-neutral-800 bg-neutral-950 px-4 py-2 text-[11px] text-neutral-500 select-none">
