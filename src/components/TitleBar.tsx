...
export function TitleBar() {
  ...
  return (
    <div className="font-primary flex shrink-0 items-center justify-between border-b border-gray-800 bg-gray-950 px-4 py-2 text-[11px] text-gray-500 select-none">
