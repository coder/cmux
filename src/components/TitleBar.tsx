...
export function TitleBar() {
  ...
  return (
    <div className="px-4 py-2 bg-bg-dark border-b border-[#3c3c3c] flex items-center justify-between font-primary text-[11px] text-[#858585] select-none flex-shrink-0">
