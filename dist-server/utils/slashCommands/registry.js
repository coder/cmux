...
exports.SLASH_COMMAND_DEFINITION_MAP = exports.SLASH_COMMAND_DEFINITIONS = exports.MODEL_ABBREVIATIONS = void 0;
...
const compactCommandDefinition = {
    ...
    handler: ({ cleanRemainingTokens }) => {
        ...
        const instructions = cleanRemainingTokens.length > instructionsStart
            ? cleanRemainingTokens.slice(instructionsStart).join(" ")
            : undefined;
        return { type: "compact", maxOutputTokens, instructions };
    },
};
const providersSetCommandDefinition = {
    key: "set",
...
const providersCommandDefinition = {
    key: "providers",
...
const modelCommandDefinition = {
    ...
    handler: ({ cleanRemainingTokens }) => {
        ...
        if (cleanRemainingTokens.length === 1) {
            ...
            if (exports.MODEL_ABBREVIATIONS[token]) {
                return {
                    type: "model-set",
                    modelString: exports.MODEL_ABBREVIATIONS[token],
                };
            }
    ...
    suggestions: ({ stage, partialToken }) => {
        ...
        if (stage === 1) {
            const abbreviationSuggestions = Object.entries(exports.MODEL_ABBREVIATIONS).map(([abbrev, fullModel]) => ({
                key: abbrev,
...
exports.SLASH_COMMAND_DEFINITIONS = [
...
exports.SLASH_COMMAND_DEFINITION_MAP = new Map(exports.SLASH_COMMAND_DEFINITIONS.map((definition) => [definition.key, definition]));
